...
description = "BetaSeries: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/BetaSeries/blob/master/README.md

License
=======
``BetaSeries`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/BetaSeries"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'BetaSeries': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
