...
*Pybids* {pybids_ver} [@yarkoni2019pybids], *Niworkflows* {niworkflows_ver},
*Nibabel* {nibabel_ver}, *Pandas* {pandas_ver} [@mckinney2010data], and
*Numpy* {numpy_ver} [@van2011numpy; @oliphant2006guide].
